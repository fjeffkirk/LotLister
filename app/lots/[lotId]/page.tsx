      ...
      <header className="border-b border-surface-800 bg-surface-900/80 backdrop-blur-sm sticky top-0 z-20">
        <div className="px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-lg">{lot.name}</h1>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative flex items-center">
              ...
              <input
                ...
                className="pr-4 py-2 w-56 text-sm bg-surface-800 border border-surface-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500"
              />
            </div>
