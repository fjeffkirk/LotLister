  ...
  return (
    <div className="modal-overlay animate-fade-in" onClick={onClose}>
      ...
      >
        ...
        {/* Image URL Warning for Export Mode */}
        {isExportMode && (
          <div className="mx-5 mb-3 p-3 bg-amber-900/30 border border-amber-600/50 rounded-lg">
            <div className="flex items-start gap-2">
              <svg className="w-5 h-5 text-amber-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
              </svg>
              <div className="text-sm">
                <p className="text-amber-300 font-medium">Image URLs Required</p>
                <p className="text-amber-200/80 mt-1">
                  eBay requires publicly accessible image URLs. The exported CSV will contain local file paths 
                  which need to be replaced with hosted URLs, or upload images directly to eBay.
                </p>
              </div>
            </div>
          </div>
